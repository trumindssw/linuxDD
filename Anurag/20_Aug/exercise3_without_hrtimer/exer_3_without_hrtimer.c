...
static void my_tasklet_func(unsigned long data)
{
    ...
    pr_info("Current Datetime writing complete in /tmp/datetime.txt , releasing the lock");
...
static int __init mydrv_init(void)
{
    ...
    // Initialising tasklets + spinlocks (not timers as we cant use in spinlocks and tasklets)
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Exercise3 driver: tasklet + spinlocks");
